...
using MiRestauranteApp.Views.Elements;
...
namespace MiRestauranteApp.Pages
{
    ...
    {
        private string _authenticated;

        public IntroPage()
        {
            InitializeComponent();

            //btnLoginGoogle.Clicked += BtnLoginGoogleOnClicked;
        ...
        private async void BtnLoginGoogleOnClicked(object sender, EventArgs eventArgs)
        {
